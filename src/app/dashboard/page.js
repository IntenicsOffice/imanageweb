        ...
        <Layout>
            <div className="row">
                ...
                <div className="col-lg-9 col-12">
                    <h2 className="text-center text-lg-start">Dashboard</h2>
                    {/* <h2 className="text-center text-lg-start">Dashboard Content Area {companyId}</h2> */}
                    {/* <p className="text-center text-lg-start">This is {process.env.NEXT_PUBLIC_API_URL} your main content will {Constants.ADMINISTRATOR}. </p> */}
                </div>
